...
export const EXTENSION_NAME = 'iconfont';
export const CONGIF_FILENAME = 'iconfont.json';
...
export const COMMAND_CONFIG = 'iconfont.config';
export const COMMAND_DOWNLOAD = "iconfont.download";
